...
function validaciones() {
  ...
  if (nombre.value == "") {
    ...
    document
      .getElementById("lcorreo")
      .parentNode.insertBefore(error, document.getElementById("lcorreo"));
...
document.getElementById("enviar").addEventListener("click", () => {
  ...
  if (validaciones()) {
    ...
    boton.href = "./iniciarPartida.html"; // Cambia el enlace del botón para iniciar partida
  }
});
